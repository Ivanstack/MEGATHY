            ...
            result => {
                ...
                switch (true) {
                    ...
                    case statusCode >= 400 && statusCode < 500:
                        if (global.currentAppLanguage != "en" && data["messageAr"] != undefined) {
    ...
    async getCategoryAndBannerData(isLoadMore) {
        ...
        let categoryData = networkUtility.getRequest(getCategoryUrl).then(
            result => {
                ...
                this.setState({
                    categoryData: [...this.state.categoryData, ...resultData.data],
                    isRefreshing: !this.state.isRefreshing,
                    // lastPage: data.last_page,
                    // currentPage: data.current_page
                });
        ...
        if (this.currentPage < this.lastPage) {
            return (
                <View style={styles.footer}>
                    <TouchableOpacity activeOpacity={0.9} onPress={this.callLoadMore} style={styles.loadMoreBtn}>
